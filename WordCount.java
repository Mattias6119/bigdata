...
public class WordCount {
  ...
  public interface WordCountOptions extends PipelineOptions {
    ...
    @Default.String("gs://dataflow-apache-quickstart_dataflowbatchjsoncsv-390314/entrada/matias.txt")
    String getInputFile();
